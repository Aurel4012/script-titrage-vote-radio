...
if ( 0 < $comptage )
{
    ...
    while ( $infos_titre = mysql_fetch_array( $query_comptage ) )
    {
        ...
        echo "cript type=\"text/javascript\" src=\"http://";
        echo $_SERVER['HTTP_HOST'];
        echo "/includes/plugins/webradios/onair/titrage_independant/vote/javascript/init-";
        echo strip_tags( utf8_encode( stripslashes( $infos_titre['vote_id'] ) ) );
        ...
        echo "\">\r\n\t\t\t\t\t<input type=\"hidden\" name=\"titre\" value=\"";
        echo strip_tags( utf8_encode( stripslashes( $infos_titre['vote_titre'] ) ) );
        echo "\">\r\n\t\t\t</form>\r\n\t\t\t</div>\t\r\n</div>\r\n\r\n\r\n<div style=\"float:right; float:right; width:50px; text-align:right; margin-right:5px; color:#333;\">\r\n";
