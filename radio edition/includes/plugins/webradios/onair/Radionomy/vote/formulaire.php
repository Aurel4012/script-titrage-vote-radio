...
error_reporting( 0 );
include( $_SERVER['DOCUMENT_ROOT']."/includes/plugins/webradios/onair/Radionomy/appel.php" );
...
echo "cript type=\"text/javascript\" src=\"http://";
echo $_SERVER['HTTP_HOST'];
echo "/includes/plugins/webradios/onair/Radionomy/vote/javascript/init.js\"></script>\r\n<link type='text/css' href='http://";
echo $_SERVER['HTTP_HOST'];
