...
echo "/includes/plugins/webradios/onair/Radionomy/vote/images/spinner.gif\";\r\n\r\nimg2 = new Image(220, 19);  \r\nimg2.src=\"http://";
echo $_SERVER['HTTP_HOST'];
echo "/includes/plugins/webradios/onair/Radionomy/vote/images/ajax-loader.gif\";\r\n\r\n// When DOM is ready\r\n$(document).ready(function(){\r\n\r\n// Launch MODAL BOX if the Login Link is clicked\r\n$(\"#login_link\").click(function(){\r\n$('#login_form').modal();\r\n});\r\n\r\n$(\"#login_link_menu\").click(function(){\r\n$('#login_form').modal();\r\n});\r\n\r\n// When the form is submitted\r\n$(\"#div_vote";
echo $vote_id;
echo " > form\").submit(function(){  \r\n\r\n// Hide 'Submit' Button\r\n$('#submit').hide();\r\n\r\n// Show Gif Spinning Rotator\r\n$('#ajax_loading').show();\r\n\r\n// 'this' refers to the current submitted form  \r\nvar str = $(this).serialize();  \r\n\r\n// -- Start AJAX Call --\r\n\r\n$.ajax({  \r\n    type: \"POST\",\r\n    url: \"http://";
echo $_SERVER['HTTP_HOST'];
echo "/includes/plugins/webradios/onair/Radionomy/vote/vote.php\",  // Send the login info to this page\r\n    data: str,  \r\n    success: function(msg){  \r\n   \r\n$(\"#div_vote";
echo $vote_id;
