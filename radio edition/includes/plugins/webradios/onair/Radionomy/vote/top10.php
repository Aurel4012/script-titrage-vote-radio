...
echo "cript type=\"text/javascript\" src=\"http://";
echo $_SERVER['HTTP_HOST'];
echo "/includes/plugins/webradios/onair/Radionomy/vote/javascript/jquery.simplemodal.js\"></script>\r\n<link type='text/css' href='http://";
echo $_SERVER['HTTP_HOST'];
echo "/includes/plugins/webradios/onair/Radionomy/vote/style/stylesheet.css' rel='stylesheet' media='screen' />\r\n<link type='text/css' href='http://";
echo $_SERVER['HTTP_HOST'];
echo "/includes/plugins/webradios/onair/Radionomy/vote/style/basic.css' rel='stylesheet' media='screen' />\r\n\r\n\r\n";
if ( 0 < $comptage )
{
    $i = 1;
    while ( $infos_titre = mysql_fetch_array( $query_comptage ) )
    {
        ...
        echo "cript type=\"text/javascript\" src=\"http://";
        echo $_SERVER['HTTP_HOST'];
        echo "/includes/plugins/webradios/onair/Radionomy/vote/javascript/init-";
        echo strip_tags( utf8_encode( $infos_titre['vote_id'] ) );
        echo ".js\"></script>\r\n\r\n<div style=\"border-bottom:solid 1px #666; color:#333; padding:1px; font-size:11px; margin-bottom:1px; height:14px;\">\r\n\r\n\r\n<div style=\"width:230px; overflow:hidden; max-width:230px; height:14px;  float:left;\">\r\n";
        echo $i;
        echo " - ";
...
echo "<div style=\"border-bottom:solid 1px #666; color:#000; padding:1px; font-size:11px; margin-bottom:1px; height:14px; overflow:hidden;\">\r\nAucun titre dans le top 10\r\n</div>\r\n\r\n";
?>
